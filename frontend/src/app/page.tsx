      ...
      <div className="mx-auto max-w-5xl">
        <div className="topbar mb-6 flex flex-col gap-5 rounded-[28px] px-6 py-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            <p className="eyebrow">Client Chat Experience</p>
            <h1 className="section-title mt-3 text-4xl font-semibold text-white md:text-5xl">
              AI Support + Sales Copilot
            </h1>
            <p className="mt-3 text-base text-[var(--muted)]">
              A clean, client-facing assistant powered by your company knowledge base.
            </p>
          </div>
        ...
        <div className="app-shell rounded-[28px] p-4 sm:p-5">
          <div className="mb-4 flex items-center justify-between border-b border-[var(--border)] pb-4">
            <div>
              ...
              <p className="mt-2 text-sm text-[var(--muted)]">
                Ask questions naturally and get grounded answers tailored to this company.
              </p>
            </div>
            <button
          ...
          <div
            ref={messagesRef}
            className="panel h-[520px] space-y-4 overflow-y-auto rounded-[24px] p-4"
          >
